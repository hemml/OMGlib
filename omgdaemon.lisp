  ...
  (with-input-from-string
    (fd (format nil "~{~A~%~}"
          `("FROM debian"
            ...
            "RUN su -l omg -c 'cd /home/omg && sbcl --eval \"(load \\\"/home/omg/quicklisp/setup.lisp\\\")\" --eval \"(ql:quickload :omg)\" --eval \"(ql:quickload :hunchentoot)\" --eval \"(omgdaemon:make-omg-daemon 8080)\" --disable-debugger'"
            "EXPOSE 8080 4008"
